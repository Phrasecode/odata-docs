...
const config: Config = {
  ...
  url: 'https://phrasecode.github.io',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      //         href: 'https://github.com/Phrasecode/odata/discussions',
      //       },
      //       {
      //         label: 'Stack Overflow',
      //         href: 'https://stackoverflow.com/questions/tagged/phrasecode-odata',
      //       },
      //     ],
      //   },
      //   {
      ...
      //   },
      // ],
      copyright: `Copyright © ${new Date().getFullYear()} PhraseCode. Built with Docusaurus.`,
    },
    prism: {
